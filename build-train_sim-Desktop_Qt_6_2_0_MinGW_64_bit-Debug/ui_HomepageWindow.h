...
public:
    ...
    QLineEdit *systemStatusLineEdit;
    ...
    void setupUi(QMainWindow *HomepageWindow)
    {
        ...
        systemStatusLineEdit = new QLineEdit(homepage);
        systemStatusLineEdit->setObjectName(QString::fromUtf8("systemStatusLineEdit"));
        systemStatusLineEdit->setGeometry(QRect(30, 240, 181, 20));
