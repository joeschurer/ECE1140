...
public:
    ...
    void setupUi(QMainWindow *TrainModel)
    {
        ...
        openDoors = new QLineEdit(centralwidget);
        openDoors->setObjectName(QString::fromUtf8("openDoors"));
        openDoors->setGeometry(QRect(10, 200, 121, 21));
        label = new QLabel(centralwidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(10, 220, 121, 16));
    ...
    void retranslateUi(QMainWindow *TrainModel)
    {
        ...
        label->setText(QCoreApplication::translate("TrainModel", "Open Train Doors", nullptr));
    } // retranslateUi
