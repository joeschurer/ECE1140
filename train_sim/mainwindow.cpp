...
void MainWindow::sel_block(){
    ...
    if(selection==0){
        ...
        ui->auth_status->setText(QString::number(temp_block.auth));
        ui->sugg_status->setText(QString::number(int(temp_block.sugg_speed/1.609))+ " mph");
        ui->commanded_status->setText(QString::number(int(temp_block.speed_limit/1.609))+ " mph");
