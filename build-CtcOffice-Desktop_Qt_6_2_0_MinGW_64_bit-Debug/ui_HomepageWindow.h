...
public:
    ...
    void setupUi(QMainWindow *HomepageWindow)
    {
        ...
        occupancyTableWidget->setGeometry(QRect(210, 30, 371, 201));
        textEdit = new QTextEdit(homepage);
        textEdit->setObjectName(QString::fromUtf8("textEdit"));
        textEdit->setGeometry(QRect(630, 30, 261, 71));
        lineEdit_3 = new QLineEdit(homepage);
        lineEdit_3->setObjectName(QString::fromUtf8("lineEdit_3"));
        lineEdit_3->setGeometry(QRect(430, 240, 113, 21));
        label_11 = new QLabel(homepage);
        label_11->setObjectName(QString::fromUtf8("label_11"));
        label_11->setGeometry(QRect(210, 240, 101, 20));
        label_12 = new QLabel(homepage);
        label_12->setObjectName(QString::fromUtf8("label_12"));
        label_12->setGeometry(QRect(210, 270, 151, 16));
        lineEdit_4 = new QLineEdit(homepage);
        lineEdit_4->setObjectName(QString::fromUtf8("lineEdit_4"));
        lineEdit_4->setGeometry(QRect(430, 270, 113, 21));
