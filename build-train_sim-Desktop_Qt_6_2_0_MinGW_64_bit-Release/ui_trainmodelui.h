...
public:
    ...
    QLineEdit *inputCurrentTempValue;
    QPushButton *inputTempConfirm;
    QLabel *PassengersOnBoardLabel;
    QLineEdit *inputPassengersOnBoard;
    QPushButton *passengersConfirm;
    QLabel *tempControlLabel;
    QLabel *tempControlValue;
    ...
    void setupUi(QWidget *TrainModelUI)
    {
        ...
        currentMode->setGeometry(QRect(20, 230, 81, 16));
        ...
        currentModeValue->setGeometry(QRect(170, 230, 171, 16));
        ...
        emergencyBrake->setGeometry(QRect(520, 400, 111, 22));
        pushButton_2 = new QPushButton(TrainModelUI);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));
        pushButton_2->setGeometry(QRect(370, 540, 131, 22));
        ...
        pushButton_3->setGeometry(QRect(520, 540, 111, 22));
        ...
        murphy_label->setGeometry(QRect(520, 470, 131, 31));
        ...
        currentTempLabel = new QLabel(TrainModelUI);
        currentTempLabel->setObjectName(QString::fromUtf8("currentTempLabel"));
        currentTempLabel->setGeometry(QRect(410, 250, 91, 20));
        inputCurrentTempValue = new QLineEdit(TrainModelUI);
        inputCurrentTempValue->setObjectName(QString::fromUtf8("inputCurrentTempValue"));
        inputCurrentTempValue->setGeometry(QRect(490, 250, 113, 21));
        inputTempConfirm = new QPushButton(TrainModelUI);
        inputTempConfirm->setObjectName(QString::fromUtf8("inputTempConfirm"));
        inputTempConfirm->setGeometry(QRect(620, 250, 80, 22));
        PassengersOnBoardLabel = new QLabel(TrainModelUI);
        PassengersOnBoardLabel->setObjectName(QString::fromUtf8("PassengersOnBoardLabel"));
        PassengersOnBoardLabel->setGeometry(QRect(410, 290, 121, 20));
        inputPassengersOnBoard = new QLineEdit(TrainModelUI);
        inputPassengersOnBoard->setObjectName(QString::fromUtf8("inputPassengersOnBoard"));
        inputPassengersOnBoard->setGeometry(QRect(530, 290, 113, 21));
        passengersConfirm = new QPushButton(TrainModelUI);
        passengersConfirm->setObjectName(QString::fromUtf8("passengersConfirm"));
        passengersConfirm->setGeometry(QRect(660, 290, 80, 22));
        tempControlLabel = new QLabel(TrainModelUI);
        tempControlLabel->setObjectName(QString::fromUtf8("tempControlLabel"));
        tempControlLabel->setGeometry(QRect(20, 210, 101, 16));
        tempControlValue = new QLabel(TrainModelUI);
        tempControlValue->setObjectName(QString::fromUtf8("tempControlValue"));
        tempControlValue->setGeometry(QRect(170, 210, 91, 16));
        listView->raise();
        ...
        currentTempLabel->raise();
        inputCurrentTempValue->raise();
        inputTempConfirm->raise();
        PassengersOnBoardLabel->raise();
        inputPassengersOnBoard->raise();
        passengersConfirm->raise();
        tempControlLabel->raise();
        tempControlValue->raise();
    ...
    void retranslateUi(QWidget *TrainModelUI)
    {
        ...
        trainWeightButton->setText(QCoreApplication::translate("TrainModelUI", "Train Weight (kg)", nullptr));
        trainLengthButton->setText(QCoreApplication::translate("TrainModelUI", "Train Length (m)", nullptr));
        ...
        currentTempValue->setText(QCoreApplication::translate("TrainModelUI", "75", nullptr));
        ...
        nextStationLabel->setText(QCoreApplication::translate("TrainModelUI", "Current Station:", nullptr));
        nextStationValue->setText(QString());
        currentTempLabel->setText(QCoreApplication::translate("TrainModelUI", "Current Temp", nullptr));
        inputTempConfirm->setText(QCoreApplication::translate("TrainModelUI", "Confirm", nullptr));
        PassengersOnBoardLabel->setText(QCoreApplication::translate("TrainModelUI", "Passengers on Board", nullptr));
        passengersConfirm->setText(QCoreApplication::translate("TrainModelUI", "Confirm", nullptr));
        tempControlLabel->setText(QCoreApplication::translate("TrainModelUI", "Temp. Control", nullptr));
        tempControlValue->setText(QCoreApplication::translate("TrainModelUI", "Heater On", nullptr));
    } // retranslateUi
